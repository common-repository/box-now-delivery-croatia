...
function boxnow_register_boxnow_canceled_order_status()
{
  register_post_status('wc-boxnow-canceled', array(
    'label' => __('Box Now Canceled', 'box-now-delivery-croatia'),
    'public' => true,
    'exclude_from_search' => false,
    'show_in_admin_all_list' => true,
    'show_in_admin_status_list' => true,
    'label_count' => _n_noop('Box Now Canceled <span class="count">(%s)</span>', 'Box Now Canceled <span class="count">(%s)</span>', 'box-now-delivery-croatia')
  ));
}

function boxnow_add_canceled_order_status($order_statuses)
{
  $order_statuses['wc-boxnow-canceled'] = __('BOX NOW Cancel Order', 'box-now-delivery-croatia');
...
function boxnow_add_cancel_order_button($actions, $order)
{
  if ($order->has_status(array('completed'))) {
    $actions['boxnow_cancel'] = array(
      ...
      'name' => __('Cancel Order', 'box-now-delivery-croatia'),
