  ...
  if (!class_exists('Box_Now_Delivery_Shipping_Method')) {
    ...
    class Box_Now_Delivery_Shipping_Method extends WC_Shipping_Method
    {
      ...
      public function __construct($instance_id = 0)
      {
        ...
        $this->method_title = __('BOX NOW Delivery', 'box-now-delivery-croatia');
        $this->method_description = __('Custom settings for the BOX NOW Delivery', 'box-now-delivery-croatia');
      ...
      function init_form_fields()
      {
        $this->form_fields = array(
          'enabled' => array(
            'title' => __('Enable/Disable', 'box-now-delivery-croatia'),
            'type' => 'checkbox',
            'description' => '',
            'default' => 'yes'
          ),
          'title' => array(
            'title' => __('Method Title', 'box-now-delivery-croatia'),
            'type' => 'text',
            'description' => __('This controls the title which the user sees during checkout.', 'box-now-delivery-croatia'),
            'default' => __('Box Now Delivery', 'box-now-delivery-croatia'),
            'desc_tip' => true,
          ),
          'cost' => array(
            'title' => __('Cost', 'box-now-delivery-croatia'),
            'type' => 'text',
            'description' => __('Enter the cost for this shipping method', 'box-now-delivery-croatia'),
            'default' => 0,
            'desc_tip' => true,
          ),
          'free_delivery_threshold' => array(
            'title' => __('Free Delivery Threshold', 'box-now-delivery-croatia'),
            'type' => 'number',
            'description' => __('If the cart total is above this amount, the shipping cost will be free.', 'box-now-delivery-croatia'),
            'default' => '',
            'desc_tip' => true,
          ),
          'taxable' => array(
            'title' => __('Taxable', 'box-now-delivery-croatia'),
            'type' => 'select',
            'description' => __('Should the shipping cost be taxed?', 'box-now-delivery-croatia'),
            'default' => 'yes',
            'options' => array(
              'yes' => __('Yes', 'box-now-delivery-croatia'),
              'no' => __('No', 'box-now-delivery-croatia'),
            ),
          ),
          'custom_weight' => array(
            'title'       => __('Max Weight (kg)', 'box-now-delivery-croatia'),
            'type'        => 'number',
            'description' => __('Maximum weight allowed for this shipping method', 'box-now-delivery-croatia'),
            'placeholder' => __('20kg', 'box-now-delivery-croatia'),
            'default' => 20,
            'desc_tip' => true,
          ...
          'dimensions' => array(
            'title' => __('Max Package Dimensions', 'box-now-delivery-croatia'),
            'type' => 'title',
            'description' => __('Maximum package size allowed for this shipping method', 'box-now-delivery-croatia'),
          ),
          'max_length' => array(
            'title' => __('Max Length (cm)', 'box-now-delivery-croatia'),
            'type' => 'number',
            'description' => __('Maximum length of package allowed for this shipping method (in cm)', 'box-now-delivery-croatia'),
            'placeholder' => __('60 cm', 'box-now-delivery-croatia'),
            'default' => 60,
            'custom_attributes' => array(),
          ),
          'max_width' => array(
            'title' => __('Max Width (cm)', 'box-now-delivery-croatia'),
            'type' => 'number',
            'description' => __('Maximum width of package allowed for this shipping method (in cm)', 'box-now-delivery-croatia'),
            'placeholder' => __('45 cm', 'box-now-delivery-croatia'),
            'default' => 45,
            'custom_attributes' => array(),
          ),
          'max_height' => array(
            'title' => __('Max Height (cm)', 'box-now-delivery-croatia'),
            'type' => 'number',
            'description' => __('Maximum height of package allowed for this shipping method (in cm)', 'box-now-delivery-croatia'),
            'placeholder' => __('36 cm', 'box-now-delivery-croatia'),
            'default' => 36,
            'custom_attributes' => array(),
          ),
          'cod_description' => array(
            'title' => __('Cash on delivery custom description settings', 'box-now-delivery-croatia'),
            'type' => 'title',
            'description' => __('Enable the custom Cash on delivery description and enter your custom text', 'box-now-delivery-croatia'),
          ),
          'enable_custom_cod_description' => array(
            'title' => __('Enable Custom Description for COD', 'box-now-delivery-croatia'),
            'type' => 'checkbox',
            'description' => __('Enable or disable the custom description when Cash on Delivery is selected.', 'box-now-delivery-croatia'),
            'default' => 'no',
            'class' => 'enable_custom_cod_description',
          ),
          'custom_cod_description' => array(
            'title' => __('Custom COD Description', 'box-now-delivery-croatia'),
            'type' => 'text',
            'description' => __('Enter the custom description for Cash on Delivery.', 'box-now-delivery-croatia'),
            'default' => '',
            'desc_tip' => true,
...
?>
 <script>
    jQuery(function($) {
        // Detect change of payment method
        $(document.body).on('change', 'input[name="payment_method"]', function() {
            // Request only the payment method section to refresh
            $.ajax({
                type: 'POST',
                ...
                success: function(response) {
                    // Only update the payment method section, leave delivery section as is
                    if (response && response.fragments) {
                        $.each(response.fragments, function(key, value) {
                            if (key === '.woocommerce-checkout-payment') {
                                $(key).replaceWith(value); // Update payment only
                            }
                        });
                    }
                }
...
// Modify the WooCommerce checkout fragments to exclude the delivery point section
add_filter('woocommerce_update_order_review_fragments', 'exclude_delivery_fragment_from_refresh', 10, 1);
function exclude_delivery_fragment_from_refresh($fragments)
{
    // Assuming your delivery section has a selector with ID '#delivery-point-section'
    if (isset($fragments['#delivery-point-section'])) {
        unset($fragments['#delivery-point-section']); // Exclude the delivery section from being updated
    }
    return $fragments;
}
